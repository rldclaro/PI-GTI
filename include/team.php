<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="text-primary text-uppercase">LR`s Business</h6>
            <h1 class="mb-5">Equipe tecnica</h1>
        </div>
        <div class="row">
            ...
            <div class="col-lg-2 col-md-5 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="fw-bold mb-0">Beatriz Rodrigues</h5>
                        <small>Gestor(a) de Projetos</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-5 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
            ...
            <div class="col-lg-2 col-md-5 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
